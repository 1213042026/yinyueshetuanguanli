...
@Service
@Transactional
public class HuodongDAOImpl extends BaseDAO<Huodong, Integer> {
	@Resource private SessionFactory sessionFactory;
	protected Class<Huodong> getReferenceClass() {
		return Huodong.class;
	}
	...
	public Page<Huodong> getRecord(DefaultQueryCondition condition) {
		Huodong entity = (Huodong)condition.getCondition();
		Criterion cr1 = null;
