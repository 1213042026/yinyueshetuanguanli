...
oFCKeditor2.ReplaceTextarea() ;
		...
		<body>
			...
			<h3><public:i18n key="function.edit" module="buMen"></public:i18n></h3>
			<ul class="content-box-tabs">
				<li><a href="#tab1" class="default-tab"><public:i18n key="function.edit" module="buMen"></public:i18n></a></li>
			</ul>
			<div class="clear"></div>
			</div>
			...
			<form action="buMen/buMen_update.do" method="post" name="mainform">
				<table>
